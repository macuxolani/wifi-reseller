package com.yourwifi.common.config;

import com.yourwifi.security.jwt.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(Arrays.stream(allowedOriginsValue.split(","))
            .map(String::trim)
